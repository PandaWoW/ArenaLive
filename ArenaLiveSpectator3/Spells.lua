...
ArenaLiveSpectator.SpellDB = {
	...
	["CooldownTypes"] = {
		...
		[86698] = "DEF_CD",				-- Guardian of the Ancient Kings
		[86669] = "DEF_CD",				-- Guardian of the Ancient Kings
	...
	["CooldownClassSpecInfo"] = {
		...
		["PALADIN"] = {
			...
			[65] = { -- Holy
				...
				[86669] = 180,			-- Guardian of the Ancient Kings
			...
			[70] = { -- Retribution
				...
				[6940] = 120,			-- Hand of Sacrifice
				[498] = 60,				-- Divine Protection
				[86698] = 180,			-- Guardian of the Ancient Kings
				[853] = 60,				-- Hammer of Justice
				[1044] = 25,			-- Hand of Freedom
				[96231] = 15,			-- Rebuke
			},
		...
		["WARLOCK"] = {
			[0] = { -- Unskilled
				...
				[132409] = 24,			-- Spell lock (Warlock)
				[48020] = 25,			-- Demonic Circle: Teleportation
	...
	["CooldownTalentInfo"] = {
		...
		["WARLOCK"] = {
			...
			[GetSpellInfo'47897'] = { -- Demonic Breath
				["action"] = "ADD",
				["spellID"] = 47897,
				["value"] = 20,
			},
