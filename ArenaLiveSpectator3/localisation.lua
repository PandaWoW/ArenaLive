...
L["Show Statistic"] = "Show Statistic";
L["Show Talents"] = "Show Talents";
L["Talent Summary"] = "Talent Summary";
L["Show Glyphs"] = "Show Glyphs";
L["Glyph Summary"] = "Glyph Summary";
...
L["Toggles Blizzard's smart camera feature, which allows smoother camera control via keyboard. Turn this off if you want to use the regular third person view."] = "Toggles Blizzard's smart camera feature, which allows smoother camera control via keyboard. Turn this off if you want to use the regular third person view.";
...
L["If checked, ArenaLive will fixate the camera on your current target."] = "If checked, ArenaLive will fixate the camera on your current target.";
...
-- Warnings:
L["WARNING! The cooldown %s (spellID = %d) does not have a cooldown priority in the spell database. Please inform the author of the addon so he can fix that."] = "WARNING! The cooldown %s (spellID = %d) does not have a cooldown priority in the spell database. Please inform the author of the addon so he can fix that.";
L["WARNING! Tried to modify cooldown of spell with the spellID %d, but the modify value was not a number."] = "WARNING! Tried to modify cooldown of spell with the spellID %d, but the modify value was not a number.";